class ConstantsValues {
  ...
  static String NO_USER = "NO_USER";
  static String CORRECT_PSD = "CORRECT_PSD";
  static String INCORRECT_PSD = "INCORRECT_PSD";

  //Les pages de l'utilisateur connecté
  static String DASHBOARD = "dashboard";
  static String PROFIL_USER = "profil";
